...
class _SplashViewState extends State<SplashView> {
  ...
  void _startDelay() {// second splash screen
    _timer = Timer(const Duration(milliseconds: 5000), () => _goToNext());
  }
  ...
  void _goToNext() {
    ...
    if (onBoarding != null) {
      if (Helper.uId != null) {//push , pop ,screen replacement
  ...
  void setSystemUIOverlayStyle() { //light , dark //color theme
